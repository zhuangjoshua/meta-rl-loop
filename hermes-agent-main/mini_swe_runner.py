#!/usr/bin/env python3
"""
SWE Runner with Takyon Trajectory Format

A runner that uses Takyon-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Takyon-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Takyon-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Takyon format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Takyon-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Takyon-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Takyon Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Takyon-Agent's built-in execution environments
    and outputs trajectories in Takyon-Agent format.
    """
    ...
    def _convert_to_takyon_format(
        ...
        """
        Convert internal message format to Takyon trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Takyon trajectory format
        trajectory = self._convert_to_takyon_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Takyon trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Takyon Trajectory Format")
    print("=" * 60)
