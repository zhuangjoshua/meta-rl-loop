...
Config via environment variables:
  ...
  MEM0_USER_ID       — User identifier (default: takyon-user)
  MEM0_AGENT_ID      — Agent identifier (default: takyon)

Or via $TAKYON_HOME/mem0.json.
"""
...
def _load_config() -> dict:
    """Load config from env vars, with $TAKYON_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "user_id": os.environ.get("MEM0_USER_ID", "takyon-user"),
        "agent_id": os.environ.get("MEM0_AGENT_ID", "takyon"),
        "rerank": True,
        "keyword_search": False,
    }

    config_path = get_takyon_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def __init__(self):
        ...
        self._api_key = ""
        self._user_id = "takyon-user"
        self._agent_id = "takyon"
        self._rerank = True
    ...
    def save_config(self, values, takyon_home):
        """Write config to $TAKYON_HOME/mem0.json."""
        import json
        from pathlib import Path
        config_path = Path(takyon_home) / "mem0.json"
        existing = {}
        if config_path.exists():
            try:
    ...
    def get_config_schema(self):
        return [
            ...
            {"key": "user_id", "description": "User identifier", "default": "takyon-user"},
            {"key": "agent_id", "description": "Agent identifier", "default": "takyon"},
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        self._user_id = kwargs.get("user_id") or self._config.get("user_id", "takyon-user")
        self._agent_id = self._config.get("agent_id", "takyon")
