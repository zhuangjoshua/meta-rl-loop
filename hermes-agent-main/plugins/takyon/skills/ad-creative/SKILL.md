...
- If the operator asks to generate a video or image, a Markdown script/shot list is not completion. It is only a supporting artifact unless `business_generate_creative_asset` returned a generated file and receipt, or the tool reported a missing credential/budget gate.
