...
TAKYON_CATEGORIES: dict[str, dict[str, str]] = {
    ...
    "experimentation": {"label": "Experimentation", "description": "Track measurable product, pricing, conversion, and distribution bets."},
...
TAKYON_TOOL_REGISTRY: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "display_name": "Read business state",
        "activity_verb": "reading business state",
        "detail_hint": "business",
        "detail_keys": ["business"],
        "implementation_status": "implemented",
        "category": "read",
        "priority_bands": ["p1_ceo", "p2_growth", "p3_learning", "p4_maintenance"],
        "effect": "read_only",
        "purpose": "Inspect one business summary, brain and research indexes, workspaces, controls, ledger, jobs, and events.",
    },
    {
    ...
    },
    {
        ...
        "display_name": "Check business pulse",
        "activity_verb": "checking business pulse",
        "detail_hint": "business",
        "detail_keys": ["business"],
        "implementation_status": "implemented",
        "category": "pulse",
    ...
    },
    {
        ...
        "display_name": "Verify website/product",
        "activity_verb": "verifying website/product",
        "detail_hint": "source path or publish target",
        "detail_keys": ["source_path", "publish_target", "business"],
        "implementation_status": "implemented",
        "category": "product",
    ...
    },
    {
        ...
        "display_name": "Prepare outreach",
        "activity_verb": "preparing outreach",
        "detail_hint": "channel, target, or destination",
        "detail_keys": ["channel", "destination_label", "destination_url", "target", "business"],
        "implementation_status": "implemented",
        "category": "outreach",
        "priority_bands": ["p2_growth", "p3_learning"],
        "effect": "mode_aware_side_effect",
        "purpose": "Publish outreach through one intent with canonical product links and an exact intended destination: test mode writes local suppressed artifacts and conversation mirrors; live mode records a gated provider publish job.",
    },
    {
    ...
    },
    {
        ...
        "display_name": "Run delegated worker",
        "activity_verb": "running delegated worker",
        "detail_hint": "workspace or delegated task purpose",
        "detail_keys": ["workspace", "source_path", "business"],
        "implementation_status": "implemented",
        "category": "agent",
        "priority_bands": ["p1_ceo", "p2_growth", "p3_learning"],
    ...
    {
        "name": "delegate_task",
        "display_name": "Run delegated agent",
        "activity_verb": "running delegated agent",
        "detail_hint": "delegated task goal",
        "detail_keys": ["goal", "task", "context", "business"],
        "implementation_status": "implemented",
        "category": "agent",
        "priority_bands": ["p1_ceo", "p2_growth", "p3_learning"],
        "effect": "agentic_write",
        "purpose": "Run bounded subagent work from the current CEO or worker turn and stream its live tool progress.",
    },
    {
        "name": "todo",
        "display_name": "Update work plan",
        "activity_verb": "updating work plan",
        "detail_hint": "current plan item",
        "detail_keys": ["todos", "action", "business"],
        "implementation_status": "implemented",
        "category": "control",
        "priority_bands": ["p1_ceo", "p4_maintenance"],
        "effect": "local_state",
        "purpose": "Track the active model work plan during a CEO or worker turn.",
    },
    {
    ...
    },
    {
        ...
        "display_name": "Record agent note",
        "activity_verb": "recording agent note",
        "detail_hint": "agent scope or status",
        "detail_keys": ["scope", "status", "business"],
        "implementation_status": "implemented",
        "category": "audit",
        "priority_bands": ["p1_ceo", "p3_learning", "p4_maintenance"],
        "effect": "durable_write",
...
TAKYON_SKILL_REGISTRY: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "display_name": "Build product surface",
        "activity_verb": "building product surface",
        "detail_hint": "product surface or app workspace",
        "implementation_status": "implemented",
        "category": "product",
        "priority_bands": ["p2_growth"],
    ...
    },
    {
        ...
        "display_name": "Research market",
        "activity_verb": "researching market",
        "detail_hint": "ICP, channel, competitor, or pricing question",
        "implementation_status": "implemented",
        "category": "research",
        "priority_bands": ["p2_growth", "p3_learning"],
        "purpose": "Gather customer, competitor, channel, pricing, demand, and market-signal evidence.",
        "use_when": "Use first for new or low-evidence businesses in operational /create/build/setup bootstraps, before product work; use later when demand evidence is missing, stale, contradictory, or strategically important: clarify ICP, customer concentration, buyer pain, intent signals, channels, competitors, pricing, positioning, and the high-level strategy needed to reach those people.",
        "keywords": ["ICP", "customer research", "market research", "demand radar", "market signals", "intent signals", "channel strategy", "competitor research", "pricing evidence", "new business bootstrap", "research first", "who to reach"],
        "capabilities": ["research_first_bootstrap", "icp_strategy", "channel_evidence", "demand_signal_capture", "business_brain_updates"],
    },
    {
    ...
    },
    {
        ...
        "use_when": "Use for launch, find-users work, bootstrap distribution, phase-one outreach, channel tests, content/social/ad campaigns, and subsequent wake reviews where prior outreach must be continued, reviewed, or replaced by the next campaign.",
        "keywords": ["phase 1 outreach", "phase-one outreach", "launch campaign", "find users", "initial distribution", "HN", "Show HN", "reddit", "social post", "campaign batch", "outreach review"],
        "capabilities": ["campaign_workspace", "multi_lane_outreach_batch", "guarded_posting_jobs", "test_mode_local_publication", "campaign_review"],
    },
    {
        "name": "ad-creative",
    ...
    },
    {
        ...
        "use_when": "Use when a business needs customer discovery, outbound, partner/community pitches, phase-one outreach touches, local suppressed/mock outreach in test mode, or follow-up copy for an active campaign.",
        "keywords": ["outreach", "mock outreach", "local publish", "suppressed outreach", "lead hypotheses", "outbound", "partner pitch", "customer discovery", "HN", "reddit", "sales copy"],
        "capabilities": ["business_publish_outreach", "test_mode_local_receipts", "conversation_mirrors", "multi_touch_copy", "provider_gated_live_publish"],
    },
    {
        "name": "sales-pipeline",
        "skill": "takyon:sales-pipeline",
        "category": "outreach",
        "priority_bands": ["p2_growth", "p3_learning"],
        "purpose": "Manage sales-led prospects, accounts, opportunities, touches, demos, and follow-up while keeping raw conversations in the conversation rail.",
        "use_when": "Use when sales-led growth is the chosen motion, named leads or accounts exist, follow-ups are due, demos or opportunities need tracking, or sales evidence should update ICP, pricing, product, or distribution.",
        "keywords": ["sales pipeline", "CRM", "lead follow-up", "account", "opportunity", "demo", "close rate", "prospect", "founder-led sales"],
        "capabilities": ["sales_records", "follow_up_tracking", "conversation_handoff", "provider_gated_enrichment"],
    },
    {
        ...
        "category": "conversion",
        "priority_bands": ["p2_growth"],
        "purpose": "Improve offer, site, onboarding, and funnel when traffic does not convert or attribution evidence is missing.",
        "use_when": "Use when traffic, signups, purchases, replies, revenue, visitor counts, conversion rates, CAC, or attribution evidence are weak, missing, or changed enough to affect the next move.",
        "keywords": ["conversion", "CRO", "traffic attribution", "funnel", "visitors", "CAC", "landing page", "onboarding", "analytics"],
        "capabilities": ["conversion_diagnosis", "attribution_gap_detection", "experiment_handoff"],
    },
    {
        "name": "experimentation",
        "skill": "takyon:experimentation",
        "category": "experimentation",
        "priority_bands": ["p2_growth", "p3_learning"],
        "purpose": "Record and review measurable product, pricing, conversion, and distribution bets.",
        "use_when": "Use when the CEO chooses a testable bet, a related skill creates a measurable hypothesis, an experiment review is due, or observed metrics should decide whether to keep, change, or stop a motion.",
        "keywords": ["experiment", "A/B test", "hypothesis", "success metric", "review date", "growth bet", "pricing test", "conversion test"],
        "capabilities": ["hypothesis_tracking", "metric_review", "learning_promotion", "provider_gated_measurement"],
    },
    {
    ...
    },
    {
        ...
        "skill": "takyon:skill-safety-review",
        "category": "control",
        "priority_bands": ["p0_control", "p1_ceo", "p3_learning"],
        "purpose": "Review third-party skills, scripts, plugins, and workflow packs before adoption.",
        "use_when": "Use before importing, adapting, installing, or trusting third-party skills, scripts, plugins, MCP servers, workflow packs, or automation snippets.",
        "keywords": ["skill safety", "malware scan", "third-party skill", "plugin audit", "secret scan", "license review", "supply chain"],
        "capabilities": ["static_review", "license_risk", "secret_pattern_scan", "provider_gate_inventory"],
    },
    {
    ...
    },
    {
        ...
        "category": "app",
        "priority_bands": ["p0_control", "p2_growth"],
        "purpose": "Configure business product app auth, customers, entitlements, checkout, subscriptions, usage budgets, surface contracts, and runtime-side instrumentation gates.",
        "use_when": "Use when a product needs real customer signup, auth/session/account rails, entitlements, checkout, subscriptions, usage budgets, surface ownership, or app/runtime instrumentation planning.",
        "keywords": ["app runtime", "auth", "checkout", "entitlements", "Stripe", "usage budget", "analytics endpoint", "traffic event", "surface contract"],
        "capabilities": ["canonical_app_runtime", "stripe_checkout", "magic_link_auth", "usage_budget", "surface_contract", "instrumentation_gate"],
    },
]
