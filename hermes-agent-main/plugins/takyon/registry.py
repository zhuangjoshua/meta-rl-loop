...
TAKYON_TOOL_REGISTRY: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "display_name": "Publish website/product",
        "activity_verb": "publishing website/product",
        ...
        "effect": "durable_write",
        "purpose": "Publish a real business-owned product/website source path and write receipts/blockers without deciding product quality. Default publication copies static output to the shared slug host; legacy shared_renderer policies are compatibility aliases only.",
    },
    {
...
TAKYON_SKILL_REGISTRY: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "keywords": ["build product", "website", "app surface", "product source", "publish site", "MVP", "checkout", "shared product blocks", "own runtime"],
        "capabilities": ["app_surface_contract", "product_source_generation", "product_surface_publication", "canonical_app_runtime", "shared_product_blocks", "own_runtime_gate"],
        "capability_gates": {
