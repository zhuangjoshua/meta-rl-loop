...
TAKYON_SKILL_REGISTRY: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "use_when": "Use when the operator asks for product/source/publication, after initial market research in an operational /create/build/setup bootstrap when the research supports a smallest useful product/site surface, when evidence makes the product bet clear enough, or when a small product artifact is the best evidence-gathering move.",
