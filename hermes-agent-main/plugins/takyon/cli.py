...
def _business_bootstrap_instruction(slug: str, goal: str, active_mode: str) -> str:
    ...
    lines = [
        ...
        "",
        "In this bootstrap turn, make visible durable progress where safe. If the operator explicitly asks for a first site/app publish,",
        ...
        "After that surface is live, create or continue distribution/campaign/ and run an opening distribution campaign batch through",
        ...
        "local/mock outreach.",
        "If the operator's immediate ask was the first site/app publish and that surface is already live, do not delay reporting that",
        "result just to finish a full opening campaign batch; record the next move and continue bootstrap after the first publish lands.",
