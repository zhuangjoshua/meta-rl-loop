...
def _business_bootstrap_instruction(
    ...
    *,
    ...
    lines = [
        ...
        "Keep the model at the default (do not pass `model`) so the landing keeps full Sonnet visual quality — speed comes from the tighter turn/effort/timeout above, not a weaker model.",
        "",
