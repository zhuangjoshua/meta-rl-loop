...
def _business_bootstrap_instruction(slug: str, goal: str, active_mode: str) -> str:
    ...
    lines = [
        ...
        "before drifting into later auth, customer, or outreach follow-on work. Let the first honest public surface go live,",
        "then continue the rest of bootstrap in the same turn.",
