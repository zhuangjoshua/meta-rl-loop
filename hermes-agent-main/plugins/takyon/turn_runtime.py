    ...
    *,
    ...
    lines = [
        ...
        *(
        ...
        "- Show at least two polished, product-specific representations of the real workflow as the visitor scrolls (for example a faithful workspace preview plus an output/detail preview). Generic icon grids, abstract gradients, and marketing copy alone do not count as product visuals.",
        "- Include a prominent proof section in the first layout. At this idea-only stage use only truthful product facts and clearly labeled evidence placeholders that can be upgraded after research; never invent customer statistics, testimonials, logos, or outcome numbers.",
