    ...
    *,
    ...
    lines = [
        ...
        *(
        ...
        "Goal: get the customer a real, branded landing page live FAST. Derive a factual landing brief from the BUSINESS IDEA ALONE — do NOT do any web research before the first landing publishes.",
        ...
        "Do not invoke a design or product skill in this brief step. Do not add a Design Direction, design dials, palette, typography, layout, section order, motion system, or visual treatment unless the business goal explicitly supplies that requirement; native Taste makes those decisions later from the factual brief.",
        ...
        "- Preserve public-navigation behavior through the AppKit-owned `usePublicSiteNavigation` hook, including distinct signed-out Log in and Sign up actions and signed-in navigation, but let the skill replace or redesign the header markup and presentation.",
