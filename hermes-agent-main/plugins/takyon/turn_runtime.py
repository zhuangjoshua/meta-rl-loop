    ...
    *,
    ...
    lines = [
        ...
        *(
        ...
        "Goal: get the customer a real, branded landing page live FAST. Derive the landing brief from the BUSINESS IDEA ALONE plus the brief-driven Taste guidance — do NOT do any web research before the first landing publishes.",
        ...
        "- instruction: Use the pinned Vite scaffold as the runtime base. Keep shared wiring through `src/lib/takyon.ts` and `src/lib/hooks.ts`. Infer one visual direction from the brief using Taste, then compose the landing freely around the real offer and any supplied generated assets. The route graph and required public/auth behavior are immutable; the section structure is not.",
        '- guidance_skills: pass exactly ["taste-frontend"]. Do not add a preset style pack; Taste must infer the business-specific direction from the brief.',
        ...
        *(
        ...
        '- guidance_skills: pass exactly ["taste-frontend"] again. Reuse the landing token language and visual thesis, but design `/app` for task completion rather than copying marketing-page composition.',
