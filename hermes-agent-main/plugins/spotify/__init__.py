...
``_check_spotify_available()`` — when the user has not run ``takyon auth
spotify``, the tools remain registered (so they appear in ``takyon
...
The Spotify auth flow (``takyon auth spotify``), CLI plumbing, and docs
