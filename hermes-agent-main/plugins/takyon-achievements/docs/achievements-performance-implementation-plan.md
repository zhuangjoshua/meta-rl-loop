# Takyon Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.takyon/plugins/takyon-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.takyon/plugins/takyon-achievements/scan_checkpoint.json`.
