# Takyon Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.takyon/plugins/takyon-achievements/state.json` (existing unlock state)
  - `~/.takyon/plugins/takyon-achievements/scan_snapshot.json` (new)
  - `~/.takyon/plugins/takyon-achievements/scan_checkpoint.json` (new)
