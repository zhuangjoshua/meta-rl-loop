"""Tests for the takyon-tools-as-MCP server module surface.
...
class TestModuleSurface:
    def test_module_imports_clean(self):
        from agent.transports import takyon_tools_mcp_server as m
    ...
    def test_expected_takyon_specific_tools_listed(self):
        """The Takyon-specific tools should be present so users on the
    ...
    def test_kanban_worker_tools_exposed(self):
        """Kanban workers run as `takyon chat -q` subprocesses; if they
...
class TestMain:
    def test_main_returns_2_when_mcp_unavailable(self, monkeypatch):
        ...
        import agent.transports.takyon_tools_mcp_server as m
