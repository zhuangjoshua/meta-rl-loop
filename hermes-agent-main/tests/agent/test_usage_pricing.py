...
def test_deepseek_v4_pro_pricing_entry_exists():
    ...
    in takyon insights because the _OFFICIAL_DOCS_PRICING table had no
...
def test_openai_gpt_5_5_pricing_entry_exists():
...
def test_openai_gpt_5_4_mini_pricing_entry_exists():
    entry = get_pricing_entry("gpt-5.4-mini", provider="openai")
