"""Tests for `takyon curator status` output.
...
def test_status_uses_last_activity_not_only_last_used(monkeypatch, capsys):
    ...
    import takyon_cli.curator as curator_cli
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated TAKYON_HOME with real agent-created skills on disk."""
    ...
    from takyon_cli import curator as curator_cli
