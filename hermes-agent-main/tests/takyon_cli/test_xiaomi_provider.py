...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from takyon_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in TAKYON_OVERLAYS
        overlay = TAKYON_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify takyon doctor recognizes Xiaomi env vars."""
