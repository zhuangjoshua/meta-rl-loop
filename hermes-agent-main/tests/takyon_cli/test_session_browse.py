"""Tests for the interactive session browser (`takyon sessions browse`).
...
from takyon_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """takyon sessions browse should be parseable."""
        from takyon_cli.main import main as _main_entry
