...
The main() function in takyon_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `takyon -c model`
...
def _build_parser():
    """Build a minimal replica of the takyon top-level parser."""
