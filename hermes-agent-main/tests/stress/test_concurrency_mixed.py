...
def worker_loop(worker_id: int, takyon_home: str, result_file: str) -> None:
...
def reclaimer_loop(takyon_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="takyon_mixed_stress_")
    print(f"TAKYON_HOME = {home}")
