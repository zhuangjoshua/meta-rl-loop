...
def _enable_managed_nous_tools(monkeypatch):
    ...
    takyon_cli.auth and takyon_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("takyon_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("takyon_cli.models.check_nous_free_tier", lambda: False)
