...
class TestFirecrawlClientConfig:
    ...
    def test_nous_auth_token_respects_takyon_home_override(self, tmp_path):
        """Auth lookup should read from TAKYON_HOME/auth.json, not ~/.takyon/auth.json."""
        real_home = tmp_path / "real-home"
        (real_home / ".takyon").mkdir(parents=True)
...
class TestBackendSelection:
    ...
    ``takyon tools``.  Falls back to key-based detection for legacy/manual
    setups.
    """
