...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("takyon_cli.config.get_config_path", return_value=config_path), \
             patch("takyon_cli.config.ensure_takyon_home"):
    ...
    def test_ensure_takyon_home_sets_0700(self):
        home = Path(self.tmpdir) / ".takyon"
        with patch("takyon_cli.config.get_takyon_home", return_value=home):
