"""
Tests for mcp_serve — Takyon MCP server.
...
def _isolate_takyon_home(tmp_path, monkeypatch):
    """Redirect TAKYON_HOME to a temp directory."""
...
def _create_test_db(db_path, session_id, messages):
    """Create a minimal SQLite DB mimicking takyon_state schema."""
