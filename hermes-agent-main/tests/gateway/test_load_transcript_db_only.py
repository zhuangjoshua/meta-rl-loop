...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.takyon/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at takyon_state import time, before pytest's TAKYON_HOME monkeypatch
    fires — the autouse fixture's TAKYON_HOME override doesn't help here.)
    """
    import takyon_state
