...
Data file: $TAKYON_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_TAKYON_HOME = Path(os.environ.get("TAKYON_HOME", Path.home() / ".takyon"))
DATA_DIR = _TAKYON_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
