...
def _profile_user_agent() -> str:
    """Return a ``takyon-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from takyon_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"takyon-cli/{_ver}"
    except Exception:
        return "takyon-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # takyon-cli UA so the catalog endpoint is reachable.
