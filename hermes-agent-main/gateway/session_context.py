"""
Session-scoped context variables for the Takyon gateway.

Replaces the previous ``os.environ``-based session state
(``TAKYON_SESSION_PLATFORM``, ``TAKYON_SESSION_CHAT_ID``, etc.) with
...
messages arrive at the same time the old code did:
    ...
    os.environ["TAKYON_SESSION_THREAD_ID"] = str(context.source.thread_id)
...
``os.getenv("TAKYON_SESSION_*", ...)`` calls.  Existing tool code only
needs to replace the import + call site:

    # before
    import os
    platform = os.getenv("TAKYON_SESSION_PLATFORM", "")
...
_SESSION_PLATFORM: ContextVar = ContextVar("TAKYON_SESSION_PLATFORM", default=_UNSET)
_SESSION_CHAT_ID: ContextVar = ContextVar("TAKYON_SESSION_CHAT_ID", default=_UNSET)
_SESSION_CHAT_NAME: ContextVar = ContextVar("TAKYON_SESSION_CHAT_NAME", default=_UNSET)
_SESSION_THREAD_ID: ContextVar = ContextVar("TAKYON_SESSION_THREAD_ID", default=_UNSET)
_SESSION_USER_ID: ContextVar = ContextVar("TAKYON_SESSION_USER_ID", default=_UNSET)
_SESSION_USER_NAME: ContextVar = ContextVar("TAKYON_SESSION_USER_NAME", default=_UNSET)
...
_SESSION_TASK_KIND: ContextVar = ContextVar("TAKYON_SESSION_TASK_KIND", default=_UNSET)
# ID of the message that triggered the current turn. Used as a reply anchor
# so background-process notifications stay inside the originating Telegram
# private-chat topic (those lanes route only with thread id + reply anchor).
_SESSION_MESSAGE_ID: ContextVar = ContextVar("TAKYON_SESSION_MESSAGE_ID", default=_UNSET)

# Cron auto-delivery vars — set per-job in run_job() so concurrent jobs
# don't clobber each other's delivery targets.
_CRON_AUTO_DELIVER_PLATFORM: ContextVar = ContextVar("TAKYON_CRON_AUTO_DELIVER_PLATFORM", default=_UNSET)
_CRON_AUTO_DELIVER_CHAT_ID: ContextVar = ContextVar("TAKYON_CRON_AUTO_DELIVER_CHAT_ID", default=_UNSET)
_CRON_AUTO_DELIVER_THREAD_ID: ContextVar = ContextVar("TAKYON_CRON_AUTO_DELIVER_THREAD_ID", default=_UNSET)

_VAR_MAP = {
    "TAKYON_SESSION_PLATFORM": _SESSION_PLATFORM,
    "TAKYON_SESSION_CHAT_ID": _SESSION_CHAT_ID,
    "TAKYON_SESSION_CHAT_NAME": _SESSION_CHAT_NAME,
    "TAKYON_SESSION_THREAD_ID": _SESSION_THREAD_ID,
    "TAKYON_SESSION_USER_ID": _SESSION_USER_ID,
    "TAKYON_SESSION_USER_NAME": _SESSION_USER_NAME,
    ...
    "TAKYON_SESSION_TASK_KIND": _SESSION_TASK_KIND,
    ...
    "TAKYON_CRON_AUTO_DELIVER_THREAD_ID": _CRON_AUTO_DELIVER_THREAD_ID,
}
...
def set_session_vars(
    ...
    tokens = [
        ...
        _SESSION_TASK_KIND.set(task_kind),
...
def get_session_env(name: str, default: str = "") -> str:
    """Read a session context variable by its legacy ``TAKYON_SESSION_*`` name.

    Drop-in replacement for ``os.getenv("TAKYON_SESSION_*", default)``.
