...
Config: ~/.takyon/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.takyon/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_takyon_home()`` helper (TAKYON_HOME-aware and
...
RULES_FILE = get_takyon_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_takyon_home() / "feishu_comment_pairing.json"
