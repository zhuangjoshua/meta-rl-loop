...
try:
    ...
    _TAKYON_VERSION = "0.0.0"

_APP_VERSION = _TAKYON_VERSION
_BOT_VERSION = _TAKYON_VERSION
_YUANBAO_INSTANCE_ID = str(TAKYON_INSTANCE_ID)  # single source: yuanbao_proto.TAKYON_INSTANCE_ID
