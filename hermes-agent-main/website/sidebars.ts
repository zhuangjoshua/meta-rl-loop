  ...
  docs: [
              ...
              items: [
                {
                  ...
                  collapsed: true,
                  items: [
                    'user-guide/skills/bundled/creative/creative-surface-refresh-audit',
                    'user-guide/skills/bundled/creative/creative-taste-frontend',
                    'user-guide/skills/bundled/creative/creative-taste-imagegen-web',
                  ],
                },
                {
                  type: 'category',
                  label: 'takyon',
                  key: 'skills-bundled-takyon',
                  collapsed: true,
                  items: [
                    'user-guide/skills/bundled/takyon/takyon-autonomous-seo-geo-operator',
                    'user-guide/skills/bundled/takyon/takyon-static-ad-creative-generator',
                    'user-guide/skills/bundled/takyon/takyon-takyon-app-runtime',
                    'user-guide/skills/bundled/takyon/takyon-takyon-brand-logo',
                    'user-guide/skills/bundled/takyon/takyon-takyon-business-metrics',
                    'user-guide/skills/bundled/takyon/takyon-takyon-distribution',
                    'user-guide/skills/bundled/takyon/takyon-takyon-lightreel-seedance-fal-ugc',
                    'user-guide/skills/bundled/takyon/takyon-takyon-market-research',
                    'user-guide/skills/bundled/takyon/takyon-takyon-meta-ads-v2',
                    'user-guide/skills/bundled/takyon/takyon-takyon-mobile-app',
                    'user-guide/skills/bundled/takyon/takyon-takyon-product',
                    'user-guide/skills/bundled/takyon/takyon-takyon-reddit-ads',
                    'user-guide/skills/bundled/takyon/takyon-takyon-x',
                    'user-guide/skills/bundled/takyon/takyon-ugc-video-ad',
                  ],
                },
              ],
            },
    ...
    },
    {
      ...
      items: [
        ...
        'guides/use-mcp-with-takyon',
        'guides/use-soul-with-takyon',
        'guides/use-voice-mode-with-takyon',
        'guides/build-a-takyon-plugin',
