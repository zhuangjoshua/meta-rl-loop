#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Takyon docs site.
...
Both publish at:
  https://takyon-agent.nousresearch.com/docs/llms.txt
  https://takyon-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://takyon-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Takyon as a Python Library", None),
        ("guides/use-mcp-with-takyon", "Use MCP with Takyon", None),
        ("guides/use-voice-mode-with-takyon", "Use Voice Mode with Takyon", None),
        ("guides/use-soul-with-takyon", "Use SOUL.md with Takyon", None),
        ("guides/build-a-takyon-plugin", "Build a Takyon Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Takyon"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "takyon-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/takyon-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Takyon Agent — Full Documentation\n",
        (
            "This file is the entire Takyon Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Takyon, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://takyon-agent.nousresearch.com/docs\n",
        "Short index: https://takyon-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
