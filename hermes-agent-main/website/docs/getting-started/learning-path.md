...
sidebar_position: 3
title: 'Learning Path'
description: 'Choose your learning path through the Takyon Agent documentation based on your experience level and goals.'
---

# Learning Path

Takyon Agent can do a lot — CLI assistant, Telegram/Discord bot, task automation, RL training, and more. This page helps you figure out where to start and what to read based on your experience level and what you're trying to accomplish.

:::tip Start Here
If you haven't installed Takyon Agent yet, begin with the [Installation guide](/docs/getting-started/installation) and then run through the [Quickstart](/docs/getting-started/quickstart). Everything below assumes you have a working installation.
:::
...
- **Just browsing?** Check the [Key Features](#key-features-at-a-glance) table for a quick overview of everything Takyon Agent can do.
...
Use Takyon Agent as an interactive terminal assistant for writing, reviewing, and running code.
...
:::tip
Pass files directly into your conversation with context files. Takyon Agent can read, edit, and run code in your projects.
:::

### "I want a Telegram/Discord bot"

Deploy Takyon Agent as a bot on your favorite messaging platform.
...
7. [Use Voice Mode with Takyon](/docs/guides/use-voice-mode-with-takyon)
...
:::tip
Cron jobs let Takyon Agent run tasks on a schedule — daily summaries, periodic checks, automated reports — without you being present.
:::

### "I want to build custom tools/skills"

Extend Takyon Agent with your own tools and reusable skill packages.

1. [Plugins](/docs/user-guide/features/plugins)
2. [Build a Takyon Plugin](/docs/guides/build-a-takyon-plugin)
...
page is for built-in Takyon core development, not the usual user/custom-tool path.
:::

### "I want to train models"

Use reinforcement learning to fine-tune model behavior with Takyon Agent's built-in RL training pipeline.
...
:::tip
RL training works best when you already understand the basics of how Takyon Agent handles conversations and tool calls. Run through the Beginner path first if you're new.
:::

### "I want to use it as a Python library"

Integrate Takyon Agent into your own Python applications programmatically.
...
| **Code Execution** | Run Python scripts that call Takyon tools programmatically | [Code Execution](/docs/user-guide/features/code-execution) |
