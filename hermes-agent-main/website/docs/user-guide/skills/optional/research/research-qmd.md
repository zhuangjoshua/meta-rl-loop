...
| | |
|---|---|
| Source | Optional — install with `takyon skills install official/research/qmd` |
...
Takyon Agent via the native MCP client. This is the preferred
...
Then configure Takyon Agent to connect via HTTP:
