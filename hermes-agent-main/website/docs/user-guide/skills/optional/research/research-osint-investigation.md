...
| | |
|---|---|
| Source | Optional — install with `takyon skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Takyon Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $TAKYON_OSINT_CACHE/icij/ (default: ~/.cache/takyon-osint/icij/).
...
# Set TAKYON_OSINT_UA=your-app/1.0 (your@email) to identify yourself
