...
| | |
|---|---|
| Source | Optional — install with `takyon skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Takyon Agent |
| License | MIT |
...
```
SCRIPT=~/.takyon/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.takyon/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
