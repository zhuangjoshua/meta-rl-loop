...
| | |
|---|---|
| Source | Optional — install with `takyon skills install official/health/neuroskill-bci` |
...
Connect Takyon to a running [NeuroSkill](https://neuroskill.com/) instance to read
