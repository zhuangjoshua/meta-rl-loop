...
| | |
|---|---|
| Source | Optional — install with `takyon skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Takyon Agent |
| License | MIT |
...
The script reads `~/.takyon/.env` for two optional defaults:
...
Helper script: `~/.takyon/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.takyon/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.takyon/.env`.
...
```bash
python3 ~/.takyon/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.takyon/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
