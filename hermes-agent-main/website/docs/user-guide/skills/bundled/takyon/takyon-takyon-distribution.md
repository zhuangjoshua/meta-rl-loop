---
title: "Takyon Distribution"
sidebar_label: "Takyon Distribution"
description: "Plan and coordinate honest cross-channel demand creation, campaign artifacts, outreach lanes, and campaign continuation for one business"
---
...
Plan and coordinate honest cross-channel demand creation, campaign artifacts, outreach lanes, and campaign continuation for one business. Use when distribution work spans channels or needs an operating plan. Do not use for channel-native X, Reddit, or paid-ad execution, or for product-surface changes.
...
| Path | `skills/takyon/takyon-distribution` |
...
- If the work turns into live organic Reddit posting/commenting, switch to `takyon-reddit`. If it turns into a live paid Meta or Reddit launch, switch to `takyon-meta-ads-v2` or `takyon-reddit-ads`.
