---
title: "Takyon Meta Ads V2"
sidebar_label: "Takyon Meta Ads V2"
description: "Launch, control, measure, and verify Meta campaigns from finished real creative, including pixel readiness and evidence-backed performance evaluation"
---
...
Launch, control, measure, and verify Meta campaigns from finished real creative, including pixel readiness and evidence-backed performance evaluation. Use when an existing image or video is ready for Meta execution or an existing campaign needs operation. Do not use to create media, fabricate attribution, hard-delete campaigns, or bypass missing authority.
...
| Path | `skills/takyon/takyon-meta-ads-v2` |
...
- The Takyon toolset must be available and the seven tools above must appear in the current Agent
  SDK tool inventory.
...
- [references/meta-mcp-tool-map.md](https://github.com/NousResearch/takyon-agent/blob/main/skills/takyon/takyon-meta-ads-v2/references/meta-mcp-tool-map.md) — capability → official MCP tool, and
  the not-supported delete/archive note.
- [references/campaign-options.md](https://github.com/NousResearch/takyon-agent/blob/main/skills/takyon/takyon-meta-ads-v2/references/campaign-options.md) — selectable campaign/adset/ad values and
  the pinned Traffic → Website-clicks default.
- [references/benchmarks.md](https://github.com/NousResearch/takyon-agent/blob/main/skills/takyon/takyon-meta-ads-v2/references/benchmarks.md) — evaluation thresholds, the learning/fatigue rules,
  and the verdict → recommended-action map used by `business_meta_ad_evaluate`.
- [references/pixel-attribution.md](https://github.com/NousResearch/takyon-agent/blob/main/skills/takyon/takyon-meta-ads-v2/references/pixel-attribution.md) — one shared pixel + per-business
  custom-conversion attribution model.
- [references/pixel-health.md](https://github.com/NousResearch/takyon-agent/blob/main/skills/takyon/takyon-meta-ads-v2/references/pixel-health.md) — the two independent proofs that a pixel is
  actually functional.
