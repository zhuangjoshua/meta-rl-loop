...
To reply non-interactively from Takyon, read the original message, compose a reply, and pipe it:
...
**Non-interactive (use this from Takyon)** — pipe the message via stdin:
