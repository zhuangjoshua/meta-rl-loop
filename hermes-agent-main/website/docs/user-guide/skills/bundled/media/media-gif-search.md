...
Set your Tenor API key in your environment (add to `~/.takyon/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/NousResearch/takyon-agent/blob/main/skills/media/gif-search/url)`
