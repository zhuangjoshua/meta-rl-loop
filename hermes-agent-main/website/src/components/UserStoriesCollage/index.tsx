  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Takyon Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Takyon &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Takyon?{' '}
        <a
          href="https://github.com/NousResearch/takyon-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
