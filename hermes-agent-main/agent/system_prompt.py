...
upstream prefix cache warm.  See ``takyon-agent-dev``'s
...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    AIAgent.  Takyon never re-renders parts of this string mid-
    ...
    # Some execution modes (cron) still want TAKYON_HOME persona while keeping
    ...
    # Pointer to the takyon-agent skill + docs for user questions about Takyon itself.
    stable_parts.append(TAKYON_AGENT_HELP_GUIDANCE)
    ...
    # TAKYON_KANBAN_TASK env var). Normal chat sessions never see
    ...
    if not agent.skip_context_files:
        ...
        # mode).  The gateway process runs from the takyon-agent install
...
def build_system_prompt(agent: Any, system_message: Optional[str] = None) -> str:
    ...
    one cached block — Takyon never rebuilds or reinjects parts of it
