...
projection into Takyon' display, approval bridging, transcript projection into
...
"codex_app_server"`. Takyon' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        if spawn_env.get("TAKYON_KANBAN_TASK"):
            kanban_db = spawn_env.get("TAKYON_KANBAN_DB")
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "TAKYON_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("TAKYON_HOME", os.path.expanduser("~/.takyon")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "takyon",
        client_title: str = "Takyon Agent",
