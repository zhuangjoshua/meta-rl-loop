...
- The wrapper exports `TAKYON_BUNDLED_SKILLS`, `TAKYON_OPTIONAL_SKILLS`, and `TAKYON_MANAGED=homebrew` so packaged installs keep runtime assets and defer upgrades to Homebrew.
