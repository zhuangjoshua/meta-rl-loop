# Streaming LLM Response Support for Takyon Agent
...
```
TAKYON_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("TAKYON_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `takyon_cli/config.py` | 1 | +streaming config defaults |
