...
```bash
python3 -m pyfiglet "TAKYON" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=TAKYON&font=Slant" | boxes -d stone
```
