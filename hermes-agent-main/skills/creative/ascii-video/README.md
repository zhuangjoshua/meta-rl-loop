...
Built for [Takyon Agent](https://github.com/NousResearch/takyon-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/takyon-agent/skills/creative/ascii-video`](https://github.com/NousResearch/takyon-agent/tree/main/skills/creative/ascii-video) via PR.
