---
name: claude-design-openai
description: Shared calm product design system for serious AI, prosumer, and productivity surfaces. Layer beneath taste-frontend and claude-design.
license: Apache-2.0
---

# Claude Design OpenAI

Layer this beneath `taste-frontend` and `claude-design` when the product should feel calm, serious,
restrained, and trustworthy. Taste adapts this vocabulary to the brief; do not copy it verbatim.

## When To Use

- AI tools
- analysis products
- serious prosumer software
- productivity surfaces
- research/publication-adjacent products
...
- generous whitespace
- quiet confidence
- editorial restraint instead of hype

## Typography

- restrained sans body with occasional editorial serif display moments
- modest weights
...
- deep ink text
- one teal accent used sparingly
- hairline borders instead of heavy chrome

## Components

- soft but not cartoonishly rounded controls
- clean cards
- restrained shadows
- quiet pills and metadata
