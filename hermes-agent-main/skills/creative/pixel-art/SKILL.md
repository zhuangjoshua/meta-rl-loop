...
```python
import sys
sys.path.insert(0, "/home/teknium/.takyon/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.takyon/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Takyon installs package this)
