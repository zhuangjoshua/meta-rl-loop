...
Control the user's Spotify account via the Takyon Spotify toolset (7 tools). Setup guide: https://takyon-agent.nousresearch.com/docs/user-guide/features/spotify
...
**`401 Unauthorized` after a retry** — refresh token revoked. Tell the user to run `takyon auth spotify` again.
