...
3. **Be native to the surface.** Reddit rewards native-post and text-conversation formats;
   Meta feed rewards UGC, before/after, and product proof; Story/Reels reward full-bleed
   vertical with one big idea.
...
- **Platforms:** Meta feed/story, Reddit feed
...
- **Platforms:** Meta feed/story, Reddit
...
- **Templates:** native_social_post (Reddit thread card)
- **Platforms:** Reddit feed/comments (also works as a screenshot on Meta)
- **Hook:** "r/`<subreddit>` — 'What finally fixed `<pain>` for me'"
- **Notes:** Mimic Reddit post structure (subreddit, upvotes, title, body). Content must read as a real community would write it. **Do not fabricate quotes attributed to real users or real subreddits as if authentic UGC** — use clearly representative copy or real, sourced UGC with rights. See `policy-checks.md`.

### 6. imessage  *(text-conversation format)*
- **Awareness:** problem_aware → product_aware
- **Proof:** social_proof
- **Templates:** text_conversation
- **Platforms:** Meta story/reels/feed, Reddit
...
- **Platforms:** Reddit, Meta feed/story
