...
DEFAULT_DATASETS = [
    ...
    "NousResearch/takyon-agent-megascience-sft1",
    "NousResearch/Takyon-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Takyon-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-takyon-agent"
]
