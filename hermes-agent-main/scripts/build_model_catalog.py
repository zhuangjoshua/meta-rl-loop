#!/usr/bin/env python3
"""Build the Takyon Model Catalog — a centralized JSON manifest of curated models.
...
Takyon CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Takyon release.
...
# Ensure TAKYON_HOME is set for imports that touch it at module level.
os.environ.setdefault("TAKYON_HOME", os.path.join(os.path.expanduser("~"), ".takyon"))

from takyon_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "takyon-agent repo",
            "docs": "https://takyon-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
