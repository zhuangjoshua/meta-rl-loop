 ...
 *
 * Symptom: in `takyon --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@takyon/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using takyon --tui and as i type multiline my caret at the end will often ' +
