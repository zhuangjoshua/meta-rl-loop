"""
Skills configuration for Takyon Agent.
`takyon skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.takyon/config.yaml under:
...
from takyon_cli.config import cfg_get, load_config, save_config
from takyon_cli.colors import Colors, color
from takyon_cli.platforms import PLATFORMS as _PLATFORMS
