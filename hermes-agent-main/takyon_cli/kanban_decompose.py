...
Invoked by ``takyon kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Takyon Agent board.
...
def _profile_author() -> str:
    """Mirror of ``takyon_cli.kanban._profile_author``."""
    return (
