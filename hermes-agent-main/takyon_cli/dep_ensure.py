...
def _has_takyon_agent_browser() -> bool:
    ...
    # install.sh installs globally into $TAKYON_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-TakyonHome", str(get_takyon_home()),
        ]
    else:
