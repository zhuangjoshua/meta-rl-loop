...
Usage:
    takyon pairing list              # Show all pending + approved users
    takyon pairing approve <platform> <code>  # Approve a pairing code
    takyon pairing revoke <platform> <user_id> # Revoke user access
    takyon pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle takyon pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: takyon pairing {list|approve|revoke|clear-pending}")
        print("Run 'takyon pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.takyon/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'takyon pairing list' to see pending codes.\n")
