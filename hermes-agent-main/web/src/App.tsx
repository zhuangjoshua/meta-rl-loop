          ...
          >
            ...
            >
              ...
              {sidebarNav.pluginItems.length > 0 && (
                <div
                  aria-labelledby="takyon-sidebar-plugin-nav-heading"
                ...
                >
                  <span
                    ...
                    id="takyon-sidebar-plugin-nav-heading"
                  >
...
function SidebarSystemActions({ onNavigate }: { onNavigate: () => void }) {
  ...
  const items: SystemActionItem[] = [
    ...
    },
    {
      action: "update",
      icon: Download,
      label: t.status.updateTakyon,
      runningLabel: t.status.updatingTakyon,
      spin: false,
    },
  ];
