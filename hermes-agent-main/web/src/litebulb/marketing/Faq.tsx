...
const QA: { q: string; a: string }[] = [
  { q: "What does Litebulb actually do?", a: "You describe a company in a sentence. Litebulb builds the product, ships a real landing page, runs acquisition (SEO, ads, social), and reinvests in what converts — autonomously." },
  { q: "Do I need to write code?", a: "No. Litebulb builds and deploys the product for you. You can chat to steer the business while it ships." },
