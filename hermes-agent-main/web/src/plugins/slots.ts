 ...
 * `window.__TAKYON_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Takyon brand in the top bar
 ...
 *  `window.__TAKYON_PLUGINS__.registerSlot(...)`.
 *
