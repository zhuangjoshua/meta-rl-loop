...
const STORAGE_KEY = "takyon-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `takyon_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "takyon-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-takyon-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-takyon-theme-font", "true");
