...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateTakyon: "Mettre à jour Takyon",
    updatingTakyon: "Mise à jour de Takyon…",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins Takyon (parité avec `takyon plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.takyon/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.takyon/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.takyon/skills/",
  ...
  achievements: {
    hero: {
      ...
      title: "Takyon Achievements",
      subtitle:
        "Badges Takyon à collectionner, gagnés à partir de l'historique réel des sessions. Les succès connus non terminés sont affichés comme Découverts ; les succès secrets restent cachés jusqu'à l'apparition du premier comportement correspondant.",
      scan_subtitle:
        "Analyse de l'historique des sessions Takyon en cours. Le premier scan peut prendre 5 à 10 secondes sur les historiques volumineux.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Dernier",
      latest_hint_empty: "utilisez Takyon davantage",
    ...
    guide: {
      ...
      secret_body:
        "Les secrets cachent leur déclencheur exact. Dès qu'Takyon détecte un signal lié, la carte passe à Découvert et affiche son exigence.",
      scan_status_header: "État du scan",
      scan_status_body:
        "Takyon analyse l'historique local une seule fois, puis les cartes apparaîtront automatiquement. Rien n'est bloqué si cela prend quelques secondes.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Takyon Agent ☤",
    },
  },
  kanban: {
