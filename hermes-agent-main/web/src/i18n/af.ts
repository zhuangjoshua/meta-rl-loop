...
export const af: Translations = {
  ...
  status: {
    ...
    stopped: "Gestop",
    updateTakyon: "Werk Takyon op",
    updatingTakyon: "Besig om Takyon op te werk…",
  ...
  pluginsPage: {
    ...
    headline:
      "Ontdek, installeer, aktiveer en werk Takyon-inproppe op (`takyon plugins` ekwivalent).",
    ...
    removeConfirm: "Verwyder hierdie inprop uit ~/.takyon/plugins/?",
    removeHint: "Slegs gebruiker-geïnstalleerde inproppe onder ~/.takyon/plugins kan verwyder word.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "Geen vaardighede gevind nie. Vaardighede word gelaai uit ~/.takyon/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Versamelbare Takyon-kentekens wat verdien word uit werklike sessiegeskiedenis. Bekende, onvoltooide prestasies word as Ontdek vertoon; Geheime prestasies bly verborge totdat die eerste ooreenstemmende gedrag verskyn.",
      scan_subtitle:
        "Takyon-sessiegeskiedenis word geskandeer. Die eerste skandering kan 5–10 sekondes neem op groot geskiedenisse.",
    },
    actions: {
      rescan: "Herskandeer",
    },
    stats: {
      ...
      latest: "Jongste",
      latest_hint_empty: "gebruik Takyon meer",
      none_yet: "Nog geen",
    },
    state: {
      unlocked: "Ontsluit",
    ...
    guide: {
      ...
      secret_body:
        "Geheime hou hul presiese sneller verborge. Sodra Takyon 'n verwante sein sien, word die kaart Ontdek en wys sy vereiste.",
      scan_status_header: "Skanderingstatus",
      scan_status_body:
        "Takyon skandeer plaaslike geskiedenis een keer, daarna verskyn kaarte outomaties. Niks is vasgevang as dit 'n paar sekondes neem nie.",
