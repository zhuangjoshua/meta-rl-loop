...
export const en: Translations = {
  ...
  status: {
    ...
    stopped: "Stopped",
    updateTakyon: "Update Takyon",
    updatingTakyon: "Updating Takyon…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Takyon plugins (`takyon plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.takyon/plugins/?",
    removeHint: "Only user-installed plugins under ~/.takyon/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.takyon/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible Takyon badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Takyon session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Takyon more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Takyon sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Takyon is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
