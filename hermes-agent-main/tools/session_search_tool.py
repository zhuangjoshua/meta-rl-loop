...
the get_anchored_view / get_messages_around primitives in takyon_state.
...
# Third-party integrations tag their sessions with TAKYON_SESSION_SOURCE=tool
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from takyon_state import DEFAULT_DB_PATH
