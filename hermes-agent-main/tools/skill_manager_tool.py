...
~/.takyon/skills/. Existing skills (bundled, hub-installed, or user-created)
...
def _guard_agent_created_enabled() -> bool:
    ...
    on via `takyon config set skills.guard_agent_created true`.
    """
    try:
...
# All skills live in ~/.takyon/skills/ (single source of truth)
    ...
    try:
        ...
        if rec.get("pinned"):
            return (
                ...
                f"`takyon curator unpin {name}` if they want to delete it. "
...
SKILL_MANAGE_SCHEMA = {
    ...
    "description": (
        ...
        f"New skills go to {display_takyon_home()}/skills/; existing skills can be modified wherever they live.\n\n"
        ...
        "will refuse with a message pointing the user to `takyon curator unpin <name>`. "
