...
Trust levels:
  - builtin:   Ships with Takyon. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.takyon/\.env|\~/\.takyon/\.env',
     "takyon_env_access", "critical", "exfiltration",
     "directly references Takyon secrets file"),
    ...
    (r'\.takyon/config\.yaml|\.takyon/SOUL\.md',
     "takyon_config_mod", "critical", "persistence",
     "references Takyon configuration files directly"),
