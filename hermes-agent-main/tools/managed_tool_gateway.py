...
def auth_json_path():
    """Return the Takyon auth store path, respecting TAKYON_HOME overrides."""
    return get_takyon_home() / "auth.json"
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        from takyon_cli.auth import resolve_nous_access_token
