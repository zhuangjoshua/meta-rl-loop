...
_HERMES_CORE_TOOLS = [
    ...
    # Artifact publishing
    "publish_artifact", "deliver_artifact_to_mac",
    # Mac-local tool bridge
    "local_browser_navigate", "local_browser_snapshot", "local_browser_click",
    "local_browser_type", "local_browser_scroll", "local_browser_back",
    "local_browser_press", "local_browser_get_images", "local_browser_vision",
    "local_browser_screenshot", "local_browser_console", "local_browser_dialog",
    "local_browser_stop",
    "local_managed_browser_start", "local_managed_browser_navigate",
    "local_managed_browser_snapshot", "local_managed_browser_click",
    "local_managed_browser_type", "local_managed_browser_scroll",
    "local_managed_browser_back", "local_managed_browser_press",
    "local_managed_browser_get_images", "local_managed_browser_screenshot",
    "local_managed_browser_vision", "local_managed_browser_console",
    "local_managed_browser_dialog", "local_managed_browser_stop",
    "local_list_files", "local_move_files",
    "local_shell_exec",
    "local_fs_list", "local_fs_read", "local_fs_write",
    "local_fs_move", "local_fs_delete",
    # Text-to-speech
    "text_to_speech",
    # Planning & memory
    "todo", "memory",
...
TOOLSETS = {
    ...
    "artifact": {
        "description": "Publish VPS-created user deliverables as signed artifacts and deliver them to the user's Mac",
        "tools": ["publish_artifact", "deliver_artifact_to_mac"],
        "includes": []
    },

    "local_browser": {
        "description": "Mac-local browser automation against the user's logged-in browser session",
        "tools": [
            "local_browser_navigate", "local_browser_snapshot", "local_browser_click",
            "local_browser_type", "local_browser_scroll", "local_browser_back",
            "local_browser_press", "local_browser_get_images", "local_browser_vision",
    ...
    "local_managed_browser": {
        "description": "Mac-local Chrome CDP automation against an Argon-owned Chrome profile",
        "tools": [
            "local_managed_browser_start", "local_managed_browser_navigate",
            "local_managed_browser_snapshot", "local_managed_browser_click",
            "local_managed_browser_type", "local_managed_browser_scroll",
    ...
    "local_files": {
        "description": "Mac-local file inspection and move-only cleanup tools",
        "tools": ["local_list_files", "local_move_files"],
        "includes": []
    },

    "local_computer": {
        "description": "Mac-local shell and scoped filesystem primitives executed by the Argon Local Executor",
        "tools": [
            "local_shell_exec",
            "local_fs_list", "local_fs_read", "local_fs_write",
            "local_fs_move", "local_fs_delete",
    ...
    "hermes-api-server": {
        ...
        "tools": [
            ...
            # Artifact publishing
            "publish_artifact", "deliver_artifact_to_mac",
            # Mac-local browser/computer tools
            "local_browser_navigate", "local_browser_snapshot", "local_browser_click",
            "local_browser_type", "local_browser_scroll", "local_browser_back",
            "local_browser_press", "local_browser_get_images", "local_browser_vision",
            "local_browser_screenshot", "local_browser_console", "local_browser_dialog",
            ...
            "local_fs_list", "local_fs_read", "local_fs_write",
            "local_fs_move", "local_fs_delete",
            # Mac device bridge for one-user VPS alpha deployments
            "mac_device_action",
            # Planning & memory
            "todo", "memory",
            # Session history search
