...
from agent.prompt_builder import build_skills_system_prompt, build_context_files_prompt, build_environment_hints, build_surface_topology_hints, load_soul_md, TOOL_USE_ENFORCEMENT_GUIDANCE, TOOL_USE_ENFORCEMENT_MODELS, GOOGLE_MODEL_OPERATIONAL_GUIDANCE, OPENAI_MODEL_EXECUTION_GUIDANCE
...
class AIAgent:
    ...
    def _build_system_prompt(self, system_message: str = None) -> str:
        ...
        # Pointer to runtime help for user questions about Argon itself.
        prompt_parts.append(ARGON_AGENT_HELP_GUIDANCE)
        ...
        _surface_hints = build_surface_topology_hints()
        if _surface_hints:
            prompt_parts.append(_surface_hints)
