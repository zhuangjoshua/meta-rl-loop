...
Policy version: `meta-policy-v5`. Parent: `meta-policy-v4`.
...
3. call `meta-copy-policy` once to choose two semantic copy treatments, BOTH anchored in
   verifiable proof: the biased control is the strongest verifiable
   adoption-proof treatment available, and the challenger explores a meaningfully
